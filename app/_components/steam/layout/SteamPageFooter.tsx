...
export const SteamPageFooter = (props: Props) => {
  return (
    <div className="my-0 mx-auto h-fit flex flex-row items-center justify-evenly bg-[#171a21] pt-[16px] pb-[60px]">
      <div className="flex flex-row items-center gap-[8px]">
        <Link href="https://www.valvesoftware.com/en/" target="_blank">
          <Image src="/images/steam/footer_logo_value.png" alt="logo" className="h-[30px] w-auto"  width={50} height={50}/>
        </Link>
      ...
      <div>
        <Image src="/images/steam/logo_steam_footer.png" alt="steam_logo_footer" width={120} height={90}/>
      </div>
    </div>
  );
};
